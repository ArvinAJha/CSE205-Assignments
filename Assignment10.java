             ...
             switch (input1)
              {
               ...
               case 'E':   //Search for String at an Index
                 ...
                 System.out.print("string at the given index is " + list1.get(searchIndex) + "\n");
                 break;
               case 'L':   //List Strings
               ...
               case 'R':  //Remove String
                 ...
                 System.out.println(list1.remove(removeIndex) + " was removed");
                 break;
               case '?':   //Display Menu
                 printMenu();
                 break;
